...
vtkStandardNewMacro(vtkPLYReaderLocal);


// Construct object with merging set to true.
vtkPLYReaderLocal::vtkPLYReaderLocal()
{
  this->FileName = NULL;
...
int vtkPLYReaderLocal::RequestData(
                              ...
                              vtkInformationVector *outputVector)
{
  ...
  for (int i = 0; i < nelems; i++)
  {
    ...
    else if ( elemName && !strcmp ("face", elemName) && numElems)
    {
...
int vtkPLYReaderLocal::CanReadFile(const char *filename)
{
...
void vtkPLYReaderLocal::PrintSelf(ostream& os, vtkIndent indent)
{
